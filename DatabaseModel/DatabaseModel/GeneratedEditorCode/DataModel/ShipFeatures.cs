...
namespace EditorDatabase.DataModel
{
	public partial class ShipFeatures
	{
		...
		private ShipFeatures(ShipFeaturesSerializable serializable, Database database)
		{
			...
			ShipWeightBonus = new NumericValue<float>(serializable.ShipWeightBonus, -1f, 100f);
			EquipmentWeightBonus = new NumericValue<float>(serializable.EquipmentWeightBonus, -1f, 100f);
			VelocityBonus = new NumericValue<float>(serializable.VelocityBonus, -1f, 100f);
			TurnRateBonus = new NumericValue<float>(serializable.TurnRateBonus, -1f, 100f);
			ArmorBonus = new NumericValue<float>(serializable.ArmorBonus, -1f, 100f);
			ShieldBonus = new NumericValue<float>(serializable.ShieldBonus, -1f, 100f);
			EnergyBonus = new NumericValue<float>(serializable.EnergyBonus, -1f, 100f);
			DroneBuildSpeedBonus = new NumericValue<float>(serializable.DroneBuildSpeedBonus, -1f, 100f);
			DroneAttackBonus = new NumericValue<float>(serializable.DroneAttackBonus, -1f, 100f);
			DroneDefenseBonus = new NumericValue<float>(serializable.DroneDefenseBonus, -1f, 100f);
		...
		public NumericValue<float> ShipWeightBonus = new NumericValue<float>(0, -1f, 100f);
		public NumericValue<float> EquipmentWeightBonus = new NumericValue<float>(0, -1f, 100f);
		public NumericValue<float> VelocityBonus = new NumericValue<float>(0, -1f, 100f);
		public NumericValue<float> TurnRateBonus = new NumericValue<float>(0, -1f, 100f);
		public NumericValue<float> ArmorBonus = new NumericValue<float>(0, -1f, 100f);
		public NumericValue<float> ShieldBonus = new NumericValue<float>(0, -1f, 100f);
		public NumericValue<float> EnergyBonus = new NumericValue<float>(0, -1f, 100f);
		public NumericValue<float> DroneBuildSpeedBonus = new NumericValue<float>(0, -1f, 100f);
		public NumericValue<float> DroneAttackBonus = new NumericValue<float>(0, -1f, 100f);
		public NumericValue<float> DroneDefenseBonus = new NumericValue<float>(0, -1f, 100f);
