	...
	public partial class ComponentStats
	{
		...
		private ComponentStats(ComponentStatsSerializable serializable, Database database)
		{
			try
			{
				...
				ArmorPointsMultiplier = new NumericValue<float>(serializable.ArmorPointsMultiplier, -1000f, 1000f);
				ArmorRepairRate = new NumericValue<float>(serializable.ArmorRepairRate, -1000000f, 1000000f);
				ArmorRepairMultiplier = new NumericValue<float>(serializable.ArmorRepairMultiplier, -10000f, 10000f);
				ArmorRepairCooldownModifier = new NumericValue<float>(serializable.ArmorRepairCooldownModifier, -1000f, 1000f);
				EnergyPoints = new NumericValue<float>(serializable.EnergyPoints, -1000000f, 1000000f);
				EnergyPointsMultiplier = new NumericValue<float>(serializable.EnergyPointsMultiplier, -10000f, 10000f);
				EnergyRechargeRate = new NumericValue<float>(serializable.EnergyRechargeRate, -1000000f, 1000000f);
				EnergyRechargeMultiplier = new NumericValue<float>(serializable.EnergyRechargeMultiplier, -10000f, 10000f);
				EnergyRechargeCooldownModifier = new NumericValue<float>(serializable.EnergyRechargeCooldownModifier, -1000f, 1000f);
				ShieldPoints = new NumericValue<float>(serializable.ShieldPoints, -1000000f, 1000000f);
				ShieldPointsMultiplier = new NumericValue<float>(serializable.ShieldPointsMultiplier, -10000f, 10000f);
				ShieldRechargeRate = new NumericValue<float>(serializable.ShieldRechargeRate, -1000000f, 1000000f);
				ShieldRechargeMultiplier = new NumericValue<float>(serializable.ShieldRechargeMultiplier, -10000f, 10000f);
				ShieldRechargeCooldownModifier = new NumericValue<float>(serializable.ShieldRechargeCooldownModifier, -1000f, 1000f);
				...
				EnginePower = new NumericValue<float>(serializable.EnginePower, 0f, 10000f);
				TurnRate = new NumericValue<float>(serializable.TurnRate, 0f, 10000f);
				Autopilot = serializable.Autopilot;
				DroneRangeModifier = new NumericValue<float>(serializable.DroneRangeModifier, -5000f, 5000f);
				DroneDamageModifier = new NumericValue<float>(serializable.DroneDamageModifier, -5000f, 5000f);
				DroneDefenseModifier = new NumericValue<float>(serializable.DroneDefenseModifier, -5000f, 5000f);
				DroneSpeedModifier = new NumericValue<float>(serializable.DroneSpeedModifier, -5000f, 5000f);
				DronesBuiltPerSecond = new NumericValue<float>(serializable.DronesBuiltPerSecond, 0f, 1000f);
				DroneBuildTimeModifier = new NumericValue<float>(serializable.DroneBuildTimeModifier, 0f, 1000f);
				WeaponFireRateModifier = new NumericValue<float>(serializable.WeaponFireRateModifier, -10000f, 10000f);
				WeaponDamageModifier = new NumericValue<float>(serializable.WeaponDamageModifier, -10000f, 10000f);
				WeaponRangeModifier = new NumericValue<float>(serializable.WeaponRangeModifier, -10000f, 10000f);
				WeaponEnergyCostModifier = new NumericValue<float>(serializable.WeaponEnergyCostModifier, -10000f, 10000f);
		...
		public void Save(ComponentStatsSerializable serializable)
		{
			...
			serializable.ArmorPointsMultiplier = ArmorPointsMultiplier.Value;
			serializable.ArmorRepairRate = ArmorRepairRate.Value;
			serializable.ArmorRepairMultiplier = ArmorRepairMultiplier.Value;
			serializable.ArmorRepairCooldownModifier = ArmorRepairCooldownModifier.Value;
			serializable.EnergyPoints = EnergyPoints.Value;
			serializable.EnergyPointsMultiplier = EnergyPointsMultiplier.Value;
			serializable.EnergyRechargeRate = EnergyRechargeRate.Value;
			serializable.EnergyRechargeMultiplier = EnergyRechargeMultiplier.Value;
			...
			serializable.ShieldPointsMultiplier = ShieldPointsMultiplier.Value;
			serializable.ShieldRechargeRate = ShieldRechargeRate.Value;
			serializable.ShieldRechargeMultiplier = ShieldRechargeMultiplier.Value;
		...
		public NumericValue<float> ArmorPointsMultiplier = new NumericValue<float>(0, -1000f, 1000f);
		public NumericValue<float> ArmorRepairRate = new NumericValue<float>(0, -1000000f, 1000000f);
		public NumericValue<float> ArmorRepairMultiplier = new NumericValue<float>(0, -10000f, 10000f);
		public NumericValue<float> ArmorRepairCooldownModifier = new NumericValue<float>(0, -1000f, 1000f);
		public NumericValue<float> EnergyPoints = new NumericValue<float>(0, -1000000f, 1000000f);
		public NumericValue<float> EnergyPointsMultiplier = new NumericValue<float>(0, -10000f, 10000f);
		public NumericValue<float> EnergyRechargeRate = new NumericValue<float>(0, -1000000f, 1000000f);
		public NumericValue<float> EnergyRechargeMultiplier = new NumericValue<float>(0, -10000f, 10000f);
		public NumericValue<float> EnergyRechargeCooldownModifier = new NumericValue<float>(0, -1000f, 1000f);
		public NumericValue<float> ShieldPoints = new NumericValue<float>(0, -1000000f, 1000000f);
		public NumericValue<float> ShieldPointsMultiplier = new NumericValue<float>(0, -10000f, 10000f);
		public NumericValue<float> ShieldRechargeRate = new NumericValue<float>(0, -1000000f, 1000000f);
		public NumericValue<float> ShieldRechargeMultiplier = new NumericValue<float>(0, -10000f, 10000f);
		public NumericValue<float> ShieldRechargeCooldownModifier = new NumericValue<float>(0, -1000f, 1000f);
		...
		public NumericValue<float> EnginePower = new NumericValue<float>(0, 0f, 10000f);
		public NumericValue<float> TurnRate = new NumericValue<float>(0, 0f, 10000f);
		public bool Autopilot;
		public NumericValue<float> DroneRangeModifier = new NumericValue<float>(0, -5000f, 5000f);
		public NumericValue<float> DroneDamageModifier = new NumericValue<float>(0, -5000f, 5000f);
		public NumericValue<float> DroneDefenseModifier = new NumericValue<float>(0, -5000f, 5000f);
		public NumericValue<float> DroneSpeedModifier = new NumericValue<float>(0, -5000f, 5000f);
		public NumericValue<float> DronesBuiltPerSecond = new NumericValue<float>(0, 0f, 1000f);
		public NumericValue<float> DroneBuildTimeModifier = new NumericValue<float>(0, 0f, 1000f);
		public NumericValue<float> WeaponFireRateModifier = new NumericValue<float>(0, -10000f, 10000f);
		public NumericValue<float> WeaponDamageModifier = new NumericValue<float>(0, -10000f, 10000f);
		public NumericValue<float> WeaponRangeModifier = new NumericValue<float>(0, -10000f, 10000f);
		public NumericValue<float> WeaponEnergyCostModifier = new NumericValue<float>(0, -10000f, 10000f);
